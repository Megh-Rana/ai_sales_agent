...
export const Breadcrumbs: React.FC = () => {
  ...
  const formatSegment = (segment: string, fullPath: string) => {
    ...
    const dictionary: Record<string, string> = {
      ...
      'command-center': t.navigation?.commandCenter || 'Revenue Command Center',
      opportunities: t.navigation?.opportunities || 'Opportunity Radar',
      copilot: t.navigation?.copilot || 'Sales Copilot',
      actions: t.navigation?.actions || 'Sales Action Center',
      ...
      profile: t.routePlaceholder?.profileTitle || 'User Profile',
      team: t.routePlaceholder?.teamTitle || 'Team & Seats',
      notifications: t.routePlaceholder?.notificationsTitle || 'Notification Channels',
      subscription: t.routePlaceholder?.subscriptionTitle || 'Subscription & Billing',
      security: t.routePlaceholder?.securityTitle || 'Security & SSO',
      admin: t.navigation?.adminPortal || 'Administration',
      users: t.navigation?.adminUsers || 'User Governance',
