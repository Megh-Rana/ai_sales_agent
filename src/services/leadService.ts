...
export class LeadDiscoveryService {
  ...
  /**
   * Discover leads by calling the backend which searches DuckDuckGo, company websites, etc.
   * No client-side mock fallback — if backend is unreachable or fails, throw so UI displays error state.
   */
