...
class TwilioService:
    ...
    def get_credentials(cls) -> Dict[str, Optional[str]]:
        ...
        # Check for dynamic tunnel file generated by automated SSH localhost.run script
        if not webhook_base or "localhost" in webhook_base:
            tunnel_candidates = [
