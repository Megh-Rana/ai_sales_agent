...
def handle_oauth_callback(
    ...
    return CRMService.get_connection_status(db, owner_id=current_user.id, crm_type=payload.crm_type)
...
@router.post(
    ...
    summary="Push newly discovered/enriched lead to connected CRM",
)
...
@router.post(
    "/sync/call",
    response_model=CRMSyncResponse,
    summary="Sync call outcome and transcript link back to CRM",
)
